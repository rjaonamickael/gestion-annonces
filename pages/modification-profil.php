    ...
    <div class="container">
        ...
        <form id="profileForm" method="post">
            ...
            <div class="form-group">
                ...
                <a href="../pages/recuperationMdp.php" class="d-block mb-2">Accédez à la modification de mot de passe
                    ici</a>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="employeeNumber" name="employeeNumber" placeholder="1 a 9999"
                    value="<?php echo htmlspecialchars($employeeNumber); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Nom de famille"
                    required value="<?php echo htmlspecialchars($lastName); ?>">
            ...
            <div class="form-group">
                ...
                <div class="d-flex align-items-center">
                    <input type="tel" class="form-control" name="homePhone" id="homePhone" placeholder="(111) 111-1111"
                        value="<?php echo htmlspecialchars($homePhone); ?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="d-flex align-items-center">
                    <input type="tel" class="form-control" id="cellPhone" name="cellPhone" placeholder="(111) 111-1113"
